...
<section class="bg-primary py-3 py-md-5 py-xl-8" style="background-color: #fff; border-color: #47b2e4; color: #47b2e4;">
    <div class="container">
      <div class="row gy-4 align-items-center">
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-center text-bg-primary">
            <div class="col-12 col-xl-9">
              <a href="{{ route('home')}}">
                <img class="img-fluid rounded mb-4" loading="lazy" src="{{asset('assets/images/logoittp.ico')}}" width="200" height="80" alt="ITTP Logo">
              </a>
              <hr class="border-primary-subtle mb-4">
              <h2 class="h1 mb-4">Sistem Pendukung Keputusan</h2>
              <p class="lead mb-5">Pemilihan Karyawan Teladan Menggunakan Metode SAW</p>
              <div class="text-endx">
        ...
        <div class="col-12 col-md-6 col-xl-5">
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">{{ __('Login') }}
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    <h3>Sign in</h3>
